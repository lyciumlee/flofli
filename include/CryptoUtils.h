...
#define SSSS(x, n) RORc((x), (n))
#define R1(x, n) (((x)&0xFFFFFFFFUL) >> (n))
#define Sigma0(x) (SSSS(x, 2) ^ SSSS(x, 13) ^ SSSS(x, 22))
#define Sigma1(x) (SSSS(x, 6) ^ SSSS(x, 11) ^ SSSS(x, 25))
#define Gamma0(x) (SSSS(x, 7) ^ SSSS(x, 18) ^ R1(x, 3))
#define Gamma1(x) (SSSS(x, 17) ^ SSSS(x, 19) ^ R1(x, 10))
